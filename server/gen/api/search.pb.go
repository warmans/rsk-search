...
var file_search_proto_rawDesc = []byte{
	...
	0x74, 0x18, 0x02, 0x20, 0x01, 0x28, 0x05, 0x52, 0x05, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0x97,
	0x06, 0x0a, 0x0d, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x12, 0x6d, 0x0a, 0x06, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x12, 0x12, 0x2e, 0x72, 0x73, 0x6b,
	...
	0x74, 0x4c, 0x69, 0x73, 0x74, 0x22, 0x38, 0x92, 0x41, 0x22, 0x0a, 0x06, 0x73, 0x65, 0x61, 0x72,
	0x63, 0x68, 0x12, 0x10, 0x50, 0x65, 0x72, 0x66, 0x6f, 0x72, 0x6d, 0x20, 0x61, 0x20, 0x73, 0x65,
	0x61, 0x72, 0x63, 0x68, 0x2a, 0x06, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x82, 0xd3, 0xe4, 0x93,
	0x02, 0x0d, 0x12, 0x0b, 0x2f, 0x61, 0x70, 0x69, 0x2f, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x12,
	0xa3, 0x01, 0x0a, 0x11, 0x47, 0x65, 0x74, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x4d, 0x65, 0x74,
	...
	0x72, 0x73, 0x6b, 0x2e, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61,
	0x74, 0x61, 0x22, 0x61, 0x92, 0x41, 0x49, 0x0a, 0x06, 0x73, 0x65, 0x61, 0x72, 0x63, 0x68, 0x12,
	...
	0x63, 0x68, 0x61, 0x62, 0x6c, 0x65, 0x20, 0x66, 0x69, 0x65, 0x6c, 0x64, 0x73, 0x2a, 0x11, 0x67,
	...
	0x61, 0x6e, 0x73, 0x63, 0x72, 0x69, 0x70, 0x74, 0x42, 0x6e, 0x5a, 0x2c, 0x67, 0x69, 0x74, 0x68,
...
var file_search_proto_goTypes = []interface{}{
	...
	nil,                            // 21: rsk.Dialog.MetadataEntry
	nil,                            // 22: rsk.Transcript.MetadataEntry
...
var file_search_proto_depIdxs = []int32{
	...
	21, // 6: rsk.Dialog.metadata:type_name -> rsk.Dialog.MetadataEntry
	22, // 7: rsk.Transcript.metadata:type_name -> rsk.Transcript.MetadataEntry
	...
	4,  // 15: rsk.SearchResultList.StatsEntry.value:type_name -> rsk.SearchStats
	1,  // 16: rsk.SearchService.Search:input_type -> rsk.SearchRequest
	23, // 17: rsk.SearchService.GetSearchMetadata:input_type -> google.protobuf.Empty
	17, // 18: rsk.SearchService.ListFieldValues:input_type -> rsk.ListFieldValuesRequest
	12, // 19: rsk.SearchService.GetTranscript:input_type -> rsk.GetTranscriptRequest
	13, // 20: rsk.SearchService.ListTranscripts:input_type -> rsk.ListTranscriptsRequest
	2,  // 21: rsk.SearchService.Search:output_type -> rsk.SearchResultList
	15, // 22: rsk.SearchService.GetSearchMetadata:output_type -> rsk.SearchMetadata
	18, // 23: rsk.SearchService.ListFieldValues:output_type -> rsk.FieldValueList
	11, // 24: rsk.SearchService.GetTranscript:output_type -> rsk.Transcript
	14, // 25: rsk.SearchService.ListTranscripts:output_type -> rsk.TranscriptList
