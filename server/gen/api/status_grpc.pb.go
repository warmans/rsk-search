...
func (c *statusServiceClient) GetQuotaSummary(ctx context.Context, in *emptypb.Empty, opts ...grpc.CallOption) (*Quotas, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(Quotas)
	err := c.cc.Invoke(ctx, StatusService_GetQuotaSummary_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedStatusServiceServer should be embedded to have
...
func (UnimplementedStatusServiceServer) GetQuotaSummary(context.Context, *emptypb.Empty) (*Quotas, error) {
	return nil, status.Error(codes.Unimplemented, "method GetQuotaSummary not implemented")
}
