...
var filter_OauthService_GetAuthURL_0 = &utilities.DoubleArray{Encoding: map[string]int{}, Base: []int(nil), Check: []int(nil)}
...
func RegisterOauthServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server OauthServiceServer) error {
	mux.Handle(http.MethodGet, pattern_OauthService_GetAuthURL_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/rsk.OauthService/GetAuthURL", runtime.WithHTTPPathPattern("/api/auth/url"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_OauthService_GetAuthURL_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_OauthService_GetAuthURL_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
	})
...
func RegisterOauthServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client OauthServiceClient) error {
	mux.Handle(http.MethodGet, pattern_OauthService_GetAuthURL_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/rsk.OauthService/GetAuthURL", runtime.WithHTTPPathPattern("/api/auth/url"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_OauthService_GetAuthURL_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
