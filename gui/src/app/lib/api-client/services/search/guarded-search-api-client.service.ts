...
export class GuardedSearchAPIClient extends SearchAPIClient {
  ...
  createTscriptImport(
    ...
    return super
      .createTscriptImport(args, requestHttpOptions)
  ...
  listTscriptImports(
    ...
    return super
      .listTscriptImports(args, requestHttpOptions)
  ...
  deleteTscript(
    ...
    return super
      .deleteTscript(args, requestHttpOptions)
  ...
  getAuthUrl(
    ...
    return super
      .getAuthUrl(args, requestHttpOptions)
  ...
  listAuthorContributions(
    ...
    return super
      .listAuthorContributions(args, requestHttpOptions)
      .pipe(
        tap(
          (res: any) =>
            guards.isRskAuthorContributionList(res) || console.error(`TypeGuard for response 'RskAuthorContributionList' caught inconsistency.`, res),
        ),
      );
  }
  ...
  listAuthorRanks(
    ...
    return super
      .listAuthorRanks(args, requestHttpOptions)
  ...
  listChangelogs(
    ...
    return super
      .listChangelogs(args, requestHttpOptions)
  ...
  listIncomingDonations(requestHttpOptions?: HttpOptions): Observable<models.RskIncomingDonationList> {
    return super
      .listIncomingDonations(requestHttpOptions)
      .pipe(
        tap(
          (res: any) => guards.isRskIncomingDonationList(res) || console.error(`TypeGuard for response 'RskIncomingDonationList' caught inconsistency.`, res),
        ),
      );
  }
  ...
  getMetadata(requestHttpOptions?: HttpOptions): Observable<models.RskMetadata> {
    return super
      .getMetadata(requestHttpOptions)
  ...
  listClaimedRewards(requestHttpOptions?: HttpOptions): Observable<models.RskClaimedRewardList> {
    return super
      .listClaimedRewards(requestHttpOptions)
  ...
  getDonationStats(requestHttpOptions?: HttpOptions): Observable<models.RskDonationStats> {
    return super
      .getDonationStats(requestHttpOptions)
  ...
  claimReward(
    ...
    return super
      .claimReward(args, requestHttpOptions)
      .pipe(tap((res: any) => typeof res === 'object' || console.error(`TypeGuard for response 'object' caught inconsistency.`, res)));
  }
  ...
  listDonationRecipients(
    ...
    return super
      .listDonationRecipients(args, requestHttpOptions)
      .pipe(
        tap(
          (res: any) => guards.isRskDonationRecipientList(res) || console.error(`TypeGuard for response 'RskDonationRecipientList' caught inconsistency.`, res),
        ),
      );
  }
  ...
  search(
    ...
    return super
      .search(args, requestHttpOptions)
  ...
  predictSearchTerm(
    ...
    return super
      .predictSearchTerm(args, requestHttpOptions)
      .pipe(
        tap(
          (res: any) => guards.isRskSearchTermPredictions(res) || console.error(`TypeGuard for response 'RskSearchTermPredictions' caught inconsistency.`, res),
        ),
      );
  }
  ...
  getRandomQuote(requestHttpOptions?: HttpOptions): Observable<models.RskRandomQuote> {
    return super
      .getRandomQuote(requestHttpOptions)
  ...
  listSongs(
    ...
    return super
      .listSongs(args, requestHttpOptions)
  ...
  listTranscripts(
    ...
    return super
      .listTranscripts(args, requestHttpOptions)
  ...
  listTranscriptChanges(
    ...
    return super
      .listTranscriptChanges(args, requestHttpOptions)
      .pipe(
        tap(
          (res: any) => guards.isRskTranscriptChangeList(res) || console.error(`TypeGuard for response 'RskTranscriptChangeList' caught inconsistency.`, res),
        ),
      );
  }
  ...
  getTranscriptChange(
    ...
    return super
      .getTranscriptChange(args, requestHttpOptions)
  ...
  deleteTranscriptChange(
    ...
    return super
      .deleteTranscriptChange(args, requestHttpOptions)
      .pipe(tap((res: any) => typeof res === 'object' || console.error(`TypeGuard for response 'object' caught inconsistency.`, res)));
  }
  ...
  updateTranscriptChange(
    ...
    return super
      .updateTranscriptChange(args, requestHttpOptions)
      .pipe(tap((res: any) => guards.isRskTranscriptChange(res) || console.error(`TypeGuard for response 'RskTranscriptChange' caught inconsistency.`, res)));
  }
  ...
  getTranscriptChangeDiff(
    ...
    return super
      .getTranscriptChangeDiff(args, requestHttpOptions)
      .pipe(
        tap(
          (res: any) => guards.isRskTranscriptChangeDiff(res) || console.error(`TypeGuard for response 'RskTranscriptChangeDiff' caught inconsistency.`, res),
        ),
      );
  }
  ...
  requestTranscriptChangeState(
    ...
    return super
      .requestTranscriptChangeState(args, requestHttpOptions)
      .pipe(tap((res: any) => typeof res === 'object' || console.error(`TypeGuard for response 'object' caught inconsistency.`, res)));
  }

  listChunkedTranscripts(requestHttpOptions?: HttpOptions): Observable<models.RskChunkedTranscriptList> {
    return super
      .listChunkedTranscripts(requestHttpOptions)
      .pipe(
        tap(
          (res: any) => guards.isRskChunkedTranscriptList(res) || console.error(`TypeGuard for response 'RskChunkedTranscriptList' caught inconsistency.`, res),
        ),
      );
  }
  ...
  getChunkContribution(
    ...
    return super
      .getChunkContribution(args, requestHttpOptions)
  ...
  deleteChunkContribution(
    ...
    return super
      .deleteChunkContribution(args, requestHttpOptions)
      .pipe(tap((res: any) => typeof res === 'object' || console.error(`TypeGuard for response 'object' caught inconsistency.`, res)));
  }
  ...
  updateChunkContribution(
    ...
    return super
      .updateChunkContribution(args, requestHttpOptions)
      .pipe(tap((res: any) => guards.isRskChunkContribution(res) || console.error(`TypeGuard for response 'RskChunkContribution' caught inconsistency.`, res)));
  }
  ...
  requestChunkContributionState(
    ...
    return super
      .requestChunkContributionState(args, requestHttpOptions)
      .pipe(tap((res: any) => guards.isRskChunkContribution(res) || console.error(`TypeGuard for response 'RskChunkContribution' caught inconsistency.`, res)));
  }
  ...
  listChunkContributions(
    ...
    return super
      .listChunkContributions(args, requestHttpOptions)
      .pipe(
        tap(
          (res: any) => guards.isRskChunkContributionList(res) || console.error(`TypeGuard for response 'RskChunkContributionList' caught inconsistency.`, res),
        ),
      );
  }
  ...
  createChunkContribution(
    ...
    return super
      .createChunkContribution(args, requestHttpOptions)
      .pipe(tap((res: any) => guards.isRskChunkContribution(res) || console.error(`TypeGuard for response 'RskChunkContribution' caught inconsistency.`, res)));
  }
  ...
  getTranscriptChunk(
    ...
    return super
      .getTranscriptChunk(args, requestHttpOptions)
  ...
  listTranscriptChunks(
    ...
    return super
      .listTranscriptChunks(args, requestHttpOptions)
      .pipe(
        tap((res: any) => guards.isRskTranscriptChunkList(res) || console.error(`TypeGuard for response 'RskTranscriptChunkList' caught inconsistency.`, res)),
      );
  }
  ...
  getTranscript(
    ...
    return super
      .getTranscript(args, requestHttpOptions)
  ...
  createTranscriptChange(
    ...
    return super
      .createTranscriptChange(args, requestHttpOptions)
      .pipe(tap((res: any) => guards.isRskTranscriptChange(res) || console.error(`TypeGuard for response 'RskTranscriptChange' caught inconsistency.`, res)));
  }
  ...
  getTranscriptDialog(
    ...
    return super
      .getTranscriptDialog(args, requestHttpOptions)
  ...
  setTranscriptRatingScore(
    ...
    return super
      .setTranscriptRatingScore(args, requestHttpOptions)
      .pipe(tap((res: any) => typeof res === 'object' || console.error(`TypeGuard for response 'object' caught inconsistency.`, res)));
  }
  ...
  bulkSetTranscriptRatingScore(
    ...
    return super
      .bulkSetTranscriptRatingScore(args, requestHttpOptions)
      .pipe(tap((res: any) => typeof res === 'object' || console.error(`TypeGuard for response 'object' caught inconsistency.`, res)));
  }
  ...
  bulkSetTranscriptTag(
    ...
    return super
      .bulkSetTranscriptTag(args, requestHttpOptions)
      .pipe(tap((res: any) => typeof res === 'object' || console.error(`TypeGuard for response 'object' caught inconsistency.`, res)));
  }

  getChunkedTranscriptChunkStats(requestHttpOptions?: HttpOptions): Observable<models.RskChunkStats> {
    return super
      .getChunkedTranscriptChunkStats(requestHttpOptions)
  ...
  listNotifications(
    ...
    return super
      .listNotifications(args, requestHttpOptions)
  ...
  markNotificationsRead(requestHttpOptions?: HttpOptions): Observable<object> {
    return super
      .markNotificationsRead(requestHttpOptions)
      .pipe(tap((res: any) => typeof res === 'object' || console.error(`TypeGuard for response 'object' caught inconsistency.`, res)));
  }
  ...
  listFieldValues(
    ...
    return super
      .listFieldValues(args, requestHttpOptions)
