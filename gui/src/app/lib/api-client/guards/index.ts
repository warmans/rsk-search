...
export function isRewardKind(arg: any): arg is models.RewardKind {
  return false || arg === models.RewardKind.UNKNOWN || arg === models.RewardKind.DONATION;
}
...
export function isRskAuthorContributionList(arg: any): arg is models.RskAuthorContributionList {
  return (
    ...
    (typeof arg.contributions === 'undefined' ||
      (Array.isArray(arg.contributions) && arg.contributions.every((item: unknown) => isRskAuthorContribution(item)))) &&
    true
  );
}
...
export function isRskChunkContributionList(arg: any): arg is models.RskChunkContributionList {
  return (
    ...
    (typeof arg.contributions === 'undefined' ||
      (Array.isArray(arg.contributions) && arg.contributions.every((item: unknown) => isRskChunkContribution(item)))) &&
    true
  );
}
...
export function isRskDonationRecipientList(arg: any): arg is models.RskDonationRecipientList {
  return (
    ...
    (typeof arg.organizations === 'undefined' ||
      (Array.isArray(arg.organizations) && arg.organizations.every((item: unknown) => isRskDonationRecipient(item)))) &&
    true
  );
}
...
export function isRskMetadata(arg: any): arg is models.RskMetadata {
  return (
    ...
    (typeof arg.episodeShortIds === 'undefined' ||
      (Array.isArray(arg.episodeShortIds) && arg.episodeShortIds.every((item: unknown) => typeof item === 'string'))) &&
...
export function isRskTranscript(arg: any): arg is models.RskTranscript {
  return (
    ...
    (typeof arg.completionReports === 'undefined' ||
      (Array.isArray(arg.completionReports) && arg.completionReports.every((item: unknown) => typeof item === 'string'))) &&
    // contributors?: string[]
